...
class CropMarginsTest {
    ...
    private fun page(width: Int, height: Int, ink: (x: Int, y: Int) -> Boolean) =
    ...
    fun contentBoundsCoverTheInkWithPadding() {
        ...
        val bounds = CropMargins.computeContentBounds(300, 300,
    ...
    fun boundsNeverLeaveThePage() {
        ...
        val bounds = CropMargins.computeContentBounds(200, 200,
    ...
    fun tinyContentDoesNotTriggerOverCropping() {
        ...
        assertNull(CropMargins.computeContentBounds(400, 400,
